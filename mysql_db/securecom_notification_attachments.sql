...
CREATE TABLE `notification_attachments` (
  ...
  CONSTRAINT `notification_attachments_ibfk_1` FOREIGN KEY (`notification_id`) REFERENCES `notifications` (`notification_id`),
  CONSTRAINT `notification_attachments_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`user_id`)
...
-- Dump completed on 2026-07-30 23:30:52

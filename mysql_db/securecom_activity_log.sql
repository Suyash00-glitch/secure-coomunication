...
CREATE TABLE `activity_log` (
  ...
  KEY `idx_activity_log_department_created` (`department_id`,`created_at` DESC),
  CONSTRAINT `fk_activity_log_department` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
...
-- Dump completed on 2026-07-30 23:30:51

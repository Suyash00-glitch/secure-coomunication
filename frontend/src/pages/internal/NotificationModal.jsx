    ...
    <div className="modal-overlay">
      <div className="modal notification-modal">
        ...
        <div className="modal-content">
          ...
          <div className="message-box"><label>Message Body</label><div>{selectedNotification.description}</div></div>
        </div>
        <div className="modal-footer">
          <button className="btn-close" onClick={() => setSelectedNotification(null)}>Close</button>
          <button
            className="btn-ack"

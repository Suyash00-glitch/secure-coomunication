...
const PAGE_META = {
  ...
  "/admin/departments": { section: "Administration", name: "Department Master" },
  ...
  "/admin/notifications/create": { section: "Notifications", name: "Create Notification" },
  // External
  ...
  "/external/notifications": { section: "Notifications", name: "Notification List" },
  "/external/notifications/create": { section: "Notifications", name: "Create Notification" },
  // Internal

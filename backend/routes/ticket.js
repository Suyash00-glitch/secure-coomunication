...
ticketRouter.get("/internal/tickets/:id",auth,internalOnly,
           getInternalTicketDetail);

ticketRouter.get("/internal/tickets/:id/responses",auth,internalOnly,
          getTicketResponses);

ticketRouter.post("/internal/tickets/:id/respond",auth,internalOnly,
          respondToTicket);

ticketRouter.get("/internal/tickets/:id/conversation",auth,internalOnly,

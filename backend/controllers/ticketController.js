...
return res.status(404).json({message:"department not found"});
    ...
    await pool.query( `INSERT INTO ticket_conversation(
    ticket_id,sender_id,sender_type,message_text)
   VALUES(?,?,?,?) `, [ticketId,user_id,"external",description]);
...
// Verify ticket belongs to this department
const [ticket] = await pool.query(
...
// Optional: remove the used response
await pool.query(

`
DELETE FROM expected_responses
